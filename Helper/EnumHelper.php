...
abstract class EnumHelper
{
     ...
     *
     * @var array<class-string<EnumHelper>, array<string, null|bool|int|float|string|array<mixed>>>
     */
     ...
     *
     * @var array<class-string<EnumHelper>, string[]>
     */
     ...
     *
     * @var array<class-string<EnumHelper>, array<string, EnumHelper>>
     */
